...
class GDGoldLineDifferenceVC: UIViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        scroll_Background.contentSize = CGSize(width: CGFloat(320), height: CGFloat(1780))
        self.browser.scalesPageToFit = true
        self.browser.contentMode = .scaleAspectFit
        self.browser.frame = CGRect(x: 0, y: 228, width: 320, height: 1560)
    ...
    func webViewDidFinishLoad(_ webView: UIWebView) {
        ...
        //        yourHTMLSourceCodeString = "<span style=\"font-family: \("System-Bold"); font-size: \(24)\">\(yourHTMLSourceCodeString!)</span>"
