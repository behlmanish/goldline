    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        NSURLConnection.sendAsynchronousRequest(urlrequest, queue: .main) { (response, data, error) in
            ...
            do {
                ...
                let sJson = try JSONSerialization.jsonObject(with: data!, options: [])
               ...
               UserDefaults.standard.set(uid, forKey: "UserID")
                ...
                UserDefaults.standard.synchronize()
            let userIUd = UserDefaults.standard.value(forKey: "UserID") as! String
                print(userIUd)
        ...
        Flurry.startSession("2N2Y5H2PS325FK4FH2W5", with: FlurrySessionBuilder
            .init()
